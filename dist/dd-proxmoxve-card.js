class DFProxmoxCard extends HTMLElement {
	...
	set hass(hass) {
		...
		stats.forEach((stat) => {
			myHTML += `
   				<div class="stat borderRed" style="width: 75px; float: left; margin: 0 10px 0 10px;" title="${hass.states['sensor.'+this.config.device+'_cpu_used'].state}">
